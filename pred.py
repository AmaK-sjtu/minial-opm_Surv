...
# Env
from networks2 import define_net
from data_loaders import *
from options import parse_args
from train_test import train, test2
...
for k, data in data_cv_splits.items():
	...
	loss_test, cindex_test, pvalue_test, surv_acc_test, grad_acc_test, pred_test,tp,fp,tn,fn = test2(opt, model, data, 'test', device)
