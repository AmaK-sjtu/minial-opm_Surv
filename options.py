...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='./data/BRCA', help="datasets")
    parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/BRCA', help='models are saved here')
    parser.add_argument('--exp_name', type=str, default='BRCA_graph_only', help='name of the project. It decides where to store samples and models')
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    #parser.add_argument('--mode', type=str, default='graph', help='mode')
    #parser.add_argument('--mode', type=str, default='pathgraphomic', help='mode')
    parser.add_argument('--mode', type=str, default='graph', help='mode')
    parser.add_argument('--model_name', type=str, default='graph', help='mode')
...
#    parser.add_argument('--act_type', type=str, default="Softmax", help='activation function')
...
#    parser.add_argument('--input_size_omic', type=int, default=80, help="input_size for omic vector")
    parser.add_argument('--input_size_omic', type=int, default=4499, help="input_size for omic vector")
    parser.add_argument('--input_size_mut', type=int, default=17690, help="input_size for mutation vector")
    parser.add_argument('--input_size_meth', type=int, default=2905, help="input_size for methylation vector")
    ################### DEG numbers
    ...
    parser.add_argument('--epoch_count', type=int, default=50, help='start of epoch')
    parser.add_argument('--batch_size', type=int, default=512, help="Number of batches to train/test for. Default: 256")
    ...
    parser.add_argument('--mut_dim', type=int, default=17690) ## mutation sites
    parser.add_argument('--meth_dim', type=int, default=2905) ## methylation sites
    ...
    parser.add_argument('--bvalue',type=float,default=0.1)
    ...
    parser.add_argument('--dropout_rate', default=0.15, type=float, help='0 - 0.25. Increasing dropout_rate helps overfitting. Some people have gone as high as 0.5. You can try adding more regularization')
    ...
    parser.add_argument('--lr', default=5e-4, type=float, help='5e-4 for Adam | 1e-3 for AdaBound')
